                                                        ...
                                                        <div className='tarjeta col-12'>
                                                          <div className='col-8 contenido'>
                                                                      ...
                                                                      <div className="input-group mr-5">
                                                                          <input class="form-control" type="text" placeholder="Numero tarjeta*" />
                                                                      ...
                                                                      <div className="input-group mt-2">
                                                                          <input class="form-control" type="text" placeholder="Nombre y Apelido*"/>
                                                                          <div className="input-group-append">                                              
                                                                      ...
                                                                      <select id="month" name="month" class="select_month cart_select italic light" class="form-control  ">
